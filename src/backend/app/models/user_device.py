...
class UserDevice(Base):
    ...
    device_name: Mapped[str] = mapped_column(String(255), nullable=False, server_default="Unknown")
    device_type: Mapped[str] = mapped_column(String(20), nullable=False, server_default="web")
