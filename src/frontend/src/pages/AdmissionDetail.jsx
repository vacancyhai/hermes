  ...
  return (
    <div>
      ...
      <div className="detail-hero hero-admission">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.75rem', flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: '0.875rem', opacity: 0.88 }}>🏛 {admission.conducting_body}</div>
          </div>
      ...
      <div className="action-bar">
        ...
        {admission.source_url && <a href={admission.source_url} target="_blank" rel="noopener noreferrer" className="share-btn">🔗 Official Website</a>}
      ...
      {admission.description && <div className="detail-section"><h2>📋 About This Admission</h2><div dangerouslySetInnerHTML={{ __html: admission.description }} style={{ fontSize: '0.9rem', color: '#334155', lineHeight: 1.65 }} /></div>}
